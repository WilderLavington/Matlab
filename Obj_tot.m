function cost = Obj_tot(parameters)
    ...
    ODE_Parameters = parameters(1:13);
    drop_out = parameters(14:14+Number_of_Nucleotides-1)';
    match_mismatch_params = parameters(14+Number_of_Nucleotides:14+Number_of_Nucleotides+10-1);
    anchor = parameters(14+Number_of_Nucleotides+10);
    dimention = parameters(end);
